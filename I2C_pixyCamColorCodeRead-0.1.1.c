...
task main()
{
	...
	const int ColorCodeByte1 = 0x12;    // You may want to make this a function parameter
//	const int ColorCodeByte2 = 0x02;    // You may want to make this a function parameter
	...
	static const ubyte nReadDevice1[] =
	{
		...
		ColorCodeByte1,      // The color code in Octal, little-endian (Color Sig 1, Color Sig 2).
//		ColorCodeByte2       // The second byte of the color code (Color Sig 2).
	};
