...
task main()
{
	...
	const ubyte ColorCodeByte1 = 0x01;    // You may want to make this a function parameter
	const ubyte ColorCodeByte2 = 0x02;    // You may want to make this a function parameter
	...
	static const ubyte nReadDevice1[] =
	{
		...
		ColorCodeByte2,      // The second byte of the color code (Color Sig 1).
		ColorCodeByte1       // The first byte of the color code (Color Sig 2).
	};
