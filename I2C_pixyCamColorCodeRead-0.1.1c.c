...
{
	//added for debugging color code reads
...
task main()
{
	...
	const ubyte ColorCodeByte1 = 0x07;    // You may want to make this a function parameter
	const ubyte ColorCodeByte2 = 0x03;    // You may want to make this a function parameter
