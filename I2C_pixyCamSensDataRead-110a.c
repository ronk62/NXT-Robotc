...
// THIS version of the program reads pixyCam using signature query. The signature being read
// in the simple example is signature 1, and is controlled via kRegisterIndex = 0x51
...
{
	const int kI2CAddress    = 0x02;     // You may want to make this a function parameter
	const int kRegisterIndex = 0x51;    // You may want to make this a function parameter
