...
// THIS version of the program reads pixyCam using signature query. The signatures being read
// in the simple example are signatures 1 and 2 - controlled via kRegisterIndex1 = 0x51
// and kRegisterIndex2
...
task main()
{
	...
	while (true)
	{
		...
		sendSensorRead(S1, nReadDevice1[0], kReplyLength);  // uncomment this line to read signature1
		//sendSensorRead(S1, nReadDevice2[0], kReplyLength);  // uncomment this line to read signature2
