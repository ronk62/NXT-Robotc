...
//ubyte height=0;
//ubyte angle=0;
//ubyte qryAddress=0x51;
//ubyte numberOfBlocks=0;


bool PIXYCreadGeneralQry(tSensors link, short &sigVal, ubyte &xPos, ubyte &yPos, ubyte &width, ubyte &height);

bool PIXYCreadSignatureQry(tSensors link, ubyte &qryAddress, ubyte &numberOfBlocks, ubyte &xPos, ubyte &yPos, ubyte &width, ubyte &height);

bool PIXYCreadColorCodeQry(tSensors link, ubyte &ColorCodeByte1, ubyte &ColorCodeByte2, ubyte &numberOfBlocks, ubyte &xPos, ubyte &yPos, ubyte &width, ubyte &height, ubyte &angle);

bool PIXYCreadAngleQry(tSensors link, ubyte &angle);
