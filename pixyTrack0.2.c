...
/**
* This program will pan the pixycam to track a color-coded object. The pixycam is mounted
...
task main()
{
	...
	int topSpeedLim=3;  // set this to a very low value for initial testing
